...
def create_new_features_from_train_test(dataset_df: pd.DataFrame, train_df: pd.DataFrame,
    ...
    For games with multiple bots, the first bot's information is used.
    Missing values are filled with 0.

    Parameters:
    -----------
        dataset_df : pandas.DataFrame
            The dataset to enhance with bot features.
            Must contain a 'game_id' column.
        train_df : pandas.DataFrame
            Training dataset containing game information.
            Must have 'game_id', 'nickname',
            'score', and 'rating' columns.
        test_df : pandas.DataFrame
            Test dataset containing game information.
            Must have the same structure as train_df.
