...
FINAL_PRED_PATH = os.path.join(PROJECT_ROOT, 'final_predictions.csv')
#============================================================
...
RANGE_N_ESTIMATORS = (100, 300)
RANGE_MAX_DEPTH_RF = (4, 15)
...
# This parameter in KFold cross-validation defines how many parts the dataset will be split into
CV_N_SPLITS = 5

# This parameter used in study.optimize() and defines the number of optimization iterations (trials) the tuner will run
N_TRIALS = 10
...
VALIDATION_SIZE = 0.2   # The relative size of the validation set
